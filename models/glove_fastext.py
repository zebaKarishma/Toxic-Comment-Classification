...
train = pd.read_csv("/Users/mtss/Desktop/dm/train_translated.csv")
test = pd.read_csv("/Users/mtss/Desktop/dm/test_translated.csv")
embedding_path = "/Users/mtss/Desktop/dm/crawl-300d-2M.vec"
embedding_path_glove = "/Users/mtss/Desktop/dm/glove.840B.300d.txt"
embed_size = 300
max_features = 130000
max_len = 220
...
for word, i in word_index.items():
    if i >= max_features: continue
    embedding_vector_glove = embedding_index_glove.get(word)
...
def build_model(lr = 0.0, lr_d = 0.0, units = 0, dr = 0.0):
    ...
    emb_ft = Embedding(max_features, embed_size, weights = [embedding_matrix], trainable = False)(inp)
    emb_gl = Embedding(max_features, embed_size, weights = [embedding_matrix_glove], trainable = False)(inp)
    fg = concatenate([(emb_ft), (emb_gl)])
    x1 = SpatialDropout1D(dr)(fg)
...
submission = pd.read_csv("/Users/mtss/Desktop/dm/sample_submission.csv")
submission[list_classes] = (pred)
submission.to_csv("submission_zk_fgt.csv", index = False)
