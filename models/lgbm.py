...
0    so <talk> and <talking> would have <Tal> <alk> in common
    """
    tokens = text.split()
...
if __name__ == '__main__':
    ...
    with timer("Reading input files"):
        train = pd.read_csv('/Users/mtss/Desktop/dm3/train_translated.csv').fillna(' ')
        test = pd.read_csv('/Users/mtss/Desktop/dm3/test_translated.csv').fillna(' ')
...
submission.to_csv("submission_lightGBM.csv", index=False, float_format="%.8f")